...
class CompatibilityDataset(Dataset):
    def __init__(self, data):
        ...
        for item in data:
            ...
            combined_features = np.concatenate((pun_features, alt_features))  # (1550,)
...
model_save_path = "compatibility_model.pth"
...
# Epoch [8/100], Train Loss: 0.9459, Eval Loss: 0.8252, Train RMSE: 0.9726, Eval RMSE: 0.9084
